 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.fML.AddConstraint#getCst <em>Cst</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.fML.AddConstraint#getFm <em>Fm</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.example.mydsl.fML.FMLPackage#getAddConstraint()
 * @model
 * @generated
 */
public interface AddConstraint extends Command
{
  /**
   ...
   * @see org.xtext.example.mydsl.fML.FMLPackage#getAddConstraint_Cst()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.fML.AddConstraint#getCst <em>Cst</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setFm(FMCommand)
   * @see org.xtext.example.mydsl.fML.FMLPackage#getAddConstraint_Fm()
   * @model containment="true"
   * @generated
   */
  FMCommand getFm();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.fML.AddConstraint#getFm <em>Fm</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
