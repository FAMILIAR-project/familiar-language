 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.fML.Leaves#getFm <em>Fm</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.example.mydsl.fML.FMLPackage#getLeaves()
 * @model
 * @generated
 */
public interface Leaves extends Command, SetCommand
{
  /**
   ...
   * @see #setFm(FMCommand)
   * @see org.xtext.example.mydsl.fML.FMLPackage#getLeaves_Fm()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.fML.Leaves#getFm <em>Fm</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
