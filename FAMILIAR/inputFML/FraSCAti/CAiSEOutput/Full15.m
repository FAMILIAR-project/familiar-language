...
FraSCAtiModules : [_frascati_implementation_osgi_felix] [_frascati_implementation_script_fscript] [_frascati_implementation_script] [_frascati_binding_jsonrpc] [_frascati_implementation_script_javascript] [_frascati_implementation_script_beanshell] [_frascati_component_factory_juliac_jdt] [_frascati_implementation_script_jruby] [_frascati_property_jaxb] [_frascati_metamodel_frascati_ext] [_frascati_implementation_fractal] [_frascati_util] [_frascati_implementation_osgi_equinox] [_frascati_all] [_frascati_implementation_osgi_knopflerfish] [_frascati_tinfi_sca_parser] [_frascati_introspection] [_frascati_implementation_velocity] [_frascati_assembly_factory_juliac_jdt_tinfi_oo] [_frascati_servlet_cxf] [_frascati_implementation_script_jython] [_frascati_binding_ws] [_frascati_explorer] [_frascati_implementation_script_xquery] [_module_gcs] [_frascati_bootstrap_jdt_rest] [_frascati_implementation_resource] _frascati_sca_parser [_frascati_all_jdk6] _frascati_assembly_factory [_frascati_implementation_script_groovy] [_frascati_metamodel_frascati] [_frascati_metamodel_oasis_csa] [_frascati_jmx] [_frascati_binding_http] [_frascati_xquery] [_frascati_sca_compiler_parent] [_frascati_util_xml] [_module_upnp] [_frascati_web_explorer_bootstrap] [_frascati_component_factory_juliac_tinfi_oo] [_frascati_implementation_spring] [_frascati_binding_jms] [_module_native] [_frascati_component_factory_tinfi_oo] [_frascati_implementation_osgi] [_frascati_web_explorer] [_frascati_assembly_factory_jdk6] [_frascati_binding_rest] [_frascati_binding_jms_tests] [_frascati_interface_wsdl] [_frascati_implementation_bpel] [_frascati_bootstrap_jdt_fractal_rest] _frascati_component_factory [_frascati_binding_rmi] [_frascati_fscript] [_frascati_metamodel_web] [_frascati_binding_factory] [_frascati_component_factory_juliac_jdk6] [_frascati_metamodel_tuscany] [_frascati_component_factory_julia] [_frascati_component_factory_juliac] :: _FraSCAtiModules ;
...
_frascati_implementation_script implies _frascati_component_factory_julia ;
_frascati_implementation_osgi implies osgi ;
_frascati_servlet_cxf implies _frascati_assembly_factory ;
sca_metamodel_gcs implies _module_gcs ;
...
sca_metamodel_frascati_web implies _frascati_metamodel_web ;
...
_frascati_metamodel_oasis_csa implies _frascati_sca_parser ;
_frascati_metamodel_web implies _frascati_sca_parser ;
_frascati_component_factory_juliac_tinfi_oo implies _frascati_component_factory_juliac ;
_frascati_metamodel_oasis_csa implies oasis_sca_to_osoa ;
...
_frascati_metamodel_oasis_csa implies sca_metamodel_oasis_csa ;
_frascati_metamodel_web implies _frascati_assembly_factory ;
...
_frascati_implementation_velocity implies frascati_implementation_velocity ;
...
oasis_sca_to_osoa implies _frascati_metamodel_oasis_csa ;
...
_frascati_implementation_velocity implies _frascati_metamodel_web ;
...
_frascati_metamodel_oasis_csa implies _frascati_assembly_factory ;
...
_frascati_implementation_velocity implies _frascati_binding_http ;
...
_frascati_implementation_velocity implies _frascati_assembly_factory ;
sca_binding_ws implies _frascati_binding_ws ;
_frascati_component_factory_julia implies _frascati_assembly_factory ;
frascati_binding_jgroups implies _module_gcs ;
...
_frascati_metamodel_web implies sca_metamodel_frascati_web ;
...
sca_metamodel_oasis_csa implies _frascati_metamodel_oasis_csa ;
...
_module_gcs implies sca_metamodel_gcs ;
...
_frascati_binding_http implies _frascati_servlet_cxf ;
...
frascati_implementation_velocity implies _frascati_implementation_velocity ;
...
_module_gcs implies frascati_binding_jgroups ;
