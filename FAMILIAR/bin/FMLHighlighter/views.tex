...
fmGrid = @PYaS[FM] (@PYad["grid.m"])
fmAlgo = @PYaS[FM] (@PYad["algo.tvl"])
fmProto = @PYaS[FM] (@PYad["proto.xml"])
fmMI = @PYaS[FM] (@PYad["MI.fml"])
cst = @PYaS[constraints] (KerberosAuth -> KDC ; )
fmService = @PYaS[aggregate] { fmAlgo fmGrid fmProto fmMI } @PYaS[withMapping] cst
\end{Verbatim}
