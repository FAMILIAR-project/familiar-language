...
public class GreaterExpression implements BooleanExpression {
			...
			if (this.expression2.getType() == Expression.INT) {
				...
				if (this.getExpression2().getType() == Expression.REAL) {
					...
					throw new IllegalExpressionException("Type error : the expression " + this.toString()
							...
							+ " ) of a greater expression must be real or int. Currently,  its type is "
	...
	public Expression toNormalForm() {
		return new GreaterExpression(this.expression1.toNormalForm(), this.expression2.toNormalForm());
	}
	...
	public BooleanExpression toSimplifiedForm() {
		...
		if ((londIDExpression1.getSymbol() != null) && (londIDExpression2.getSymbol() != null)) {
			...
			BooleanExpression simplifiedExpression = new LowerExpression(this.expression1, this.expression2).toSimplifiedForm();
