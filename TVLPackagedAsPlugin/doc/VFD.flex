...
FeatureIdentifier     = [:uppercase:]([:jletter:] [:jletterdigit:])*
AttributeIdentifier   = [:lowercase:]([:jletter:] [:jletterdigit:])*

Comment 	   = "/*" ~"*/"

PosInteger     = [1-9][0-9]*
NegInteger     = "-"[1-9][0-9]*
Integer        =  0 | PosInteger | NegInteger
...
{NegInteger}                       { return symbol(sym.NEGINT,yytext()); }
{Real}                             { return symbol(sym.REAL,yytext()); }

// Properties
"dag"                             { return symbol(sym.DAG); }
