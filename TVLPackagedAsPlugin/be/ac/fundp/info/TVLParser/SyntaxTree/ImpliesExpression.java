...
public class ImpliesExpression implements BooleanExpression {

	Expression expression1, expression2;

	public ImpliesExpression(Expression e1, Expression e2) {
	...
	public Expression toNormalForm() {
		return new ImpliesExpression(this.expression1.toNormalForm(), this.expression2.toNormalForm());
	}

	public BooleanExpression toSimplifiedForm() {
		return new OrExpression(new NotExpression(((BooleanExpression) this.expression1).toSimplifiedForm()),
				((BooleanExpression) this.expression2).toSimplifiedForm());
	}

	public BooleanExpression removeArrows() {
		return new OrExpression(new NotExpression(((BooleanExpression) this.expression1).removeArrows()),
