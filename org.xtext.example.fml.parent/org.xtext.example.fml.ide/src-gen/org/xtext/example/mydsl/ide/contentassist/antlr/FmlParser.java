...
import org.xtext.example.mydsl.ide.contentassist.antlr.internal.InternalFmlParser;
...
public class FmlParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalFmlParser createParser() {
		InternalFmlParser result = new InternalFmlParser(null);
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalFmlParser typedParser = (InternalFmlParser) parser;
