...
public class FmlSyntacticSequencer extends AbstractSyntacticSequencer {
	 ...
	 *     (rule start) (ambiguity) vid=FML_IDENTIFIER
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) v=FMCommand
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) LEFT_PAREN features+=Production
	 *     (rule start) (ambiguity) LEFT_PAREN file=StringExpr
	 *     (rule start) (ambiguity) LEFT_PAREN root=ID
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) fm=FMCommand
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     stream=FML_IDENTIFIER (ambiguity) 'into' ns=FML_IDENTIFIER
	 *     stream=FML_IDENTIFIER (ambiguity) (rule end)
	 *     stream=STRING (ambiguity) 'into' ns=FML_IDENTIFIER
	 *     stream=STRING (ambiguity) (rule end)
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) B_NOT expr=Primary_expr
	 *     (rule start) (ambiguity) name='false'
	 *     (rule start) (ambiguity) name='true'
	 *     (rule start) (ambiguity) name=FT_ID
	 *     (rule start) (ambiguity) {And_expr.left=}
	 *     (rule start) (ambiguity) {Biimpl_expr.left=}
	 *     (rule start) (ambiguity) {Impl_expr.left=}
