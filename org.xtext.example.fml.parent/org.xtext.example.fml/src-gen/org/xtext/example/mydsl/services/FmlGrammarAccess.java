...
public class FmlGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class FamiliarScriptElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.FamiliarScript");
	...
	public class ScriptCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.ScriptCommand");
		...
		//var=FML_IDENTIFIER (LEFT_HOOK META_ATTRIBUTE_SYMBOL metaID=StringExpr RIGHT_HOOK)? '=' cmd=ComplexCommand
	...
	public class ComplexCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.ComplexCommand");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
		...
		//{BoolOperation.left=current} op=BOOL_Operator right=ComplexCommand
		...
		//{SetOperation.left=current} sop=SetOperator right=ComplexCommand
	...
	public class CommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Command");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
		...
		//Command:
		//	LEFT_PAREN ComplexCommand RIGHT_PAREN | (StringExpr
		//	| SetExpr
		//	| BooleanExpr
		//	| IdentifierExpr
		//	| IntegerExpr
		...
		//FeatureVariabilityOperator | IfCondition | ForeachSet | FeatureModel | AddConstraint // only internal constraints (see aggregate)
		//| RemoveConstraint // what about associating an id to a constraint?
		//| SetOperations | AnalysisOperation | FeatureOperation // children, sibling, parent, operator
		//| StringOperation | Compare | LoadGeneric | Merge | AggregateMerge | Synthesis | Hierarchy | FeatureModelOperation // insert, remove, rename, extract
		//| Aggregate | Slice | Map | UnMap | AtomicConstraintExpr | ConstraintExpr | GetConstraints | ComputeConstraints |
		//GetFGroups | ComputeFGroups | VariableNull | Cores | Deads | Cliques | Leaves | FullMandatorys | PrinterUtility |
		//Convert | Assertion | GDisplay | GListing | CleanUp | AsFM | ModifyVOperator | FMLSave | ConfigurationCmd |
		//ScriptDefinition | Shell | CopyVariable | RemoveVariable | CTCRCommand | PairwiseCommand)
		public Alternatives getAlternatives() { return cAlternatives; }
		...
		//ForeachSet | FeatureModel | AddConstraint // only internal constraints (see aggregate)
		//| RemoveConstraint // what about associating an id to a constraint?
		//| SetOperations | AnalysisOperation | FeatureOperation // children, sibling, parent, operator
		//| StringOperation | Compare | LoadGeneric | Merge | AggregateMerge | Synthesis | Hierarchy | FeatureModelOperation // insert, remove, rename, extract
		//| Aggregate | Slice | Map | UnMap | AtomicConstraintExpr | ConstraintExpr | GetConstraints | ComputeConstraints |
	...
	public class IntegerExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.IntegerExpr");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BooleanExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.BooleanExpr");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class IdentifierExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.IdentifierExpr");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class StringExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.StringExpr");
	...
	public class SetExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.SetExpr");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AtomicConstraintExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.AtomicConstraintExpr");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConstraintExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.ConstraintExpr");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FeatureVariabilityOperatorElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.FeatureVariabilityOperator");
		private final Assignment cValAssignment = (Assignment)rule.eContents().get(1);
	...
	public class IfConditionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.IfCondition");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//IfCondition:
		//	'if' LEFT_PAREN bexpr=ComplexCommand RIGHT_PAREN 'then' //BCommand | ComparisonExpression
		//	then+=ScriptCommand+ ('else' else+=ScriptCommand+)?
		//	'end';
		@Override public ParserRule getRule() { return rule; }
		
		//'if' LEFT_PAREN bexpr=ComplexCommand RIGHT_PAREN 'then' //BCommand | ComparisonExpression
		//then+=ScriptCommand+ ('else' else+=ScriptCommand+)? 'end'
		public Group getGroup() { return cGroup; }
	...
	public class ForeachSetElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.ForeachSet");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//ForeachSet:
		//	'foreach' LEFT_PAREN val=FML_IDENTIFIER 'in' var=FML_IDENTIFIER RIGHT_PAREN 'do'
		//	exprs+=ScriptCommand+
		//	'end';
		@Override public ParserRule getRule() { return rule; }
	...
	public class LTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.lType");
		private final Assignment cValAssignment = (Assignment)rule.eContents().get(1);
	...
	public class FMLAbstractCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.FMLAbstractCommand");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class FMCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.FMCommand");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class FTCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.FTCommand");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cIdentifierExprParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cCopyVariableParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
	...
	public class BCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.BCommand");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cIdentifierExprParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
	...
	public class StrCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.StrCommand");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cIdentifierExprParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cCopyVariableParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
	...
	public class ConfigurationCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.ConfigurationCommand");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cIdentifierExprParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
	...
	public class SetCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.SetCommand");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cIdentifierExprParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		...
		//SetCommand:
		//	IdentifierExpr | SetExpr | FeatureOperation | Cliques | Cores | Deads | FullMandatorys | SetToNames |
		//	SetUnionOrIntersection | Leaves | SetEmpty | SelectedConfiguration | DeselectedConfiguration | ConstraintExpr |
		...
		//// TODO: AnalysisOperation due to 'features'
		//SetToNames
	...
	public class LeavesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Leaves");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConstraintCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.ConstraintCommand");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cIdentifierExprParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
	...
	public class GetConstraintsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.GetConstraints");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ComputeConstraintsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.ComputeConstraints");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class GetFGroupsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.GetFGroups");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ComputeFGroupsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.ComputeFGroups");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cKindOfGroupsAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class PairwiseCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.PairwiseCommand");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class IntegerCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.IntegerCommand");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cIdentifierExprParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
	...
	public class DoubleCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.DoubleCommand");
	...
	public class VariabilityOpCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.VariabilityOpCommand");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cIdentifierExprParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cCopyVariableParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
	...
	public class AnalysisOperationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.AnalysisOperation");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SetOperationsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.SetOperations");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class SetCardElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.SetCard");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SetBelongsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.SetBelongs");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SetUnionOrIntersectionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.SetUnionOrIntersection");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cOpAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final Alternatives cOpAlternatives_0_0 = (Alternatives)cOpAssignment_0.eContents().get(0);
	...
	public class SetEmptyElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.SetEmpty");
		private final Assignment cValAssignment = (Assignment)rule.eContents().get(1);
	...
	public class SetAddOrRemoveElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.SetAddOrRemove");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cOpAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final Alternatives cOpAlternatives_0_0 = (Alternatives)cOpAssignment_0.eContents().get(0);
	...
	public class IsEmptySetElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.IsEmptySet");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SetToNamesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.SetToNames");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FeatureOperationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.FeatureOperation");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cOpAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final Alternatives cOpAlternatives_0_0 = (Alternatives)cOpAssignment_0.eContents().get(0);
	...
	public class AncestorFeatureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.AncestorFeature");
		private final Assignment cValAssignment = (Assignment)rule.eContents().get(1);
	...
	public class DescendantFeatureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.DescendantFeature");
		private final Assignment cValAssignment = (Assignment)rule.eContents().get(1);
	...
	public class ChildrenFeatureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.ChildrenFeature");
		private final Assignment cValAssignment = (Assignment)rule.eContents().get(1);
	...
	public class SiblingFeatureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.SiblingFeature");
		private final Assignment cValAssignment = (Assignment)rule.eContents().get(1);
	...
	public class ParentFeatureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.ParentFeature");
		private final Assignment cValAssignment = (Assignment)rule.eContents().get(1);
	...
	public class NameFeatureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.NameFeature");
		private final Assignment cValAssignment = (Assignment)rule.eContents().get(1);
	...
	public class FMFeatureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.FMFeature");
		private final Assignment cValAssignment = (Assignment)rule.eContents().get(1);
	...
	public class FeatureOperatorElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.FeatureOperator");
		private final Assignment cValAssignment = (Assignment)rule.eContents().get(1);
	...
	public class StringOperationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.StringOperation");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class StringInitElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.StringInit");
		private final Assignment cValAssignment = (Assignment)rule.eContents().get(1);
	...
	public class StringConcatElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.StringConcat");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class StringSubstringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.StringSubstring");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class StringIndexOfElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.StringIndexOf");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class StringLengthElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.StringLength");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CompareElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Compare");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ParameterElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Parameter");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class LoadGenericElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.LoadGeneric");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CTCRCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.CTCRCommand");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MergeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Merge");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final Assignment cLazyAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final Keyword cLazyLazyKeyword_2_0 = (Keyword)cLazyAssignment_2.eContents().get(0);
		private final Assignment cModeAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cModeMergeModeEnumRuleCall_3_0 = (RuleCall)cModeAssignment_3.eContents().get(0);
		private final Alternatives cAlternatives_4 = (Alternatives)cGroup.eContents().get(4);
		private final Group cGroup_4_0 = (Group)cAlternatives_4.eContents().get(0);
		private final RuleCall cLEFT_BRACKETTerminalRuleCall_4_0_0 = (RuleCall)cGroup_4_0.eContents().get(0);
		private final Assignment cLfmsAssignment_4_0_1 = (Assignment)cGroup_4_0.eContents().get(1);
		private final RuleCall cLfmsFMCommandParserRuleCall_4_0_1_0 = (RuleCall)cLfmsAssignment_4_0_1.eContents().get(0);
		private final RuleCall cRIGHT_BRACKETTerminalRuleCall_4_0_2 = (RuleCall)cGroup_4_0.eContents().get(2);
		private final Assignment cFmsAssignment_4_1 = (Assignment)cAlternatives_4.eContents().get(1);
		private final RuleCall cFmsLFMArgsParserRuleCall_4_1_0 = (RuleCall)cFmsAssignment_4_1.eContents().get(0);
		
		/// ****** COMPOSITION OPERATORS *********** / Merge:
		//	'merge' backend=BDDBackend? lazy?='--lazy'? mode=MergeMode (LEFT_BRACKET
		//	lfms+=FMCommand+
		//	RIGHT_BRACKET | fms=LFMArgs);
		@Override public ParserRule getRule() { return rule; }
		
		//'merge' backend=BDDBackend? lazy?='--lazy'? mode=MergeMode (LEFT_BRACKET lfms+=FMCommand+ RIGHT_BRACKET | fms=LFMArgs)
		public Group getGroup() { return cGroup; }
		...
		//lazy?='--lazy'?
		public Assignment getLazyAssignment_2() { return cLazyAssignment_2; }
		
		//'--lazy'
		public Keyword getLazyLazyKeyword_2_0() { return cLazyLazyKeyword_2_0; }
		
		//mode=MergeMode
		public Assignment getModeAssignment_3() { return cModeAssignment_3; }
		
		//MergeMode
		public RuleCall getModeMergeModeEnumRuleCall_3_0() { return cModeMergeModeEnumRuleCall_3_0; }
		...
		//LEFT_BRACKET
		public RuleCall getLEFT_BRACKETTerminalRuleCall_4_0_0() { return cLEFT_BRACKETTerminalRuleCall_4_0_0; }
		
		//lfms+=FMCommand+
		public Assignment getLfmsAssignment_4_0_1() { return cLfmsAssignment_4_0_1; }
		
		//FMCommand
		public RuleCall getLfmsFMCommandParserRuleCall_4_0_1_0() { return cLfmsFMCommandParserRuleCall_4_0_1_0; }
		
		//RIGHT_BRACKET
		public RuleCall getRIGHT_BRACKETTerminalRuleCall_4_0_2() { return cRIGHT_BRACKETTerminalRuleCall_4_0_2; }
		
		//fms=LFMArgs
		public Assignment getFmsAssignment_4_1() { return cFmsAssignment_4_1; }
		
		//LFMArgs
		public RuleCall getFmsLFMArgsParserRuleCall_4_1_0() { return cFmsLFMArgsParserRuleCall_4_1_0; }
	}
	public class LFMArgsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.LFMArgs");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AggregateMergeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.AggregateMerge");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//AggregateMerge:
		//	'aggregateMerge' (hierarchySpecified?='--hierarchy' hierarchyStrategy=HierarchyStrategy)?
		//	mode=MergeMode (LEFT_BRACKET
		//	lfms+=FMCommand+
		//	RIGHT_BRACKET | fms=LFMArgs);
		@Override public ParserRule getRule() { return rule; }
	...
	public class SynthesisElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Synthesis");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final Group cGroup_3 = (Group)cGroup.eContents().get(3);
		private final Assignment cOverAssignment_3_0 = (Assignment)cGroup_3.eContents().get(0);
		private final Keyword cOverOverKeyword_3_0_0 = (Keyword)cOverAssignment_3_0.eContents().get(0);
		private final Assignment cFtsAssignment_3_1 = (Assignment)cGroup_3.eContents().get(1);
		private final RuleCall cFtsSetCommandParserRuleCall_3_1_0 = (RuleCall)cFtsAssignment_3_1.eContents().get(0);
		private final Group cGroup_4 = (Group)cGroup.eContents().get(4);
		private final Keyword cWithKeyword_4_0 = (Keyword)cGroup_4.eContents().get(0);
		private final Assignment cKstAssignment_4_1 = (Assignment)cGroup_4.eContents().get(1);
		private final RuleCall cKstKnowledgeSpecificationParserRuleCall_4_1_0 = (RuleCall)cKstAssignment_4_1.eContents().get(0);
		...
		// * / Synthesis:
		//	'ksynthesis' interactive?='--interactive'? fm=FMCommand (over?='over' fts=SetCommand)? ('with'
		...
		//over?='over'
		public Assignment getOverAssignment_3_0() { return cOverAssignment_3_0; }
		
		//'over'
		public Keyword getOverOverKeyword_3_0_0() { return cOverOverKeyword_3_0_0; }
		
		//fts=SetCommand
		public Assignment getFtsAssignment_3_1() { return cFtsAssignment_3_1; }
		
		//SetCommand
		public RuleCall getFtsSetCommandParserRuleCall_3_1_0() { return cFtsSetCommandParserRuleCall_3_1_0; }
		...
		//kst=KnowledgeSpecification
		public Assignment getKstAssignment_4_1() { return cKstAssignment_4_1; }
		
		//KnowledgeSpecification
		public RuleCall getKstKnowledgeSpecificationParserRuleCall_4_1_0() { return cKstKnowledgeSpecificationParserRuleCall_4_1_0; }
	}
	public class KnowledgeSpecificationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.KnowledgeSpecification");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class HierarchySpecificationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.HierarchySpecification");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class HProductionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.HProduction");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class GroupsSpecificationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.GroupsSpecification");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class GroupSpecElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.GroupSpec");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class XorGroupSpecElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.XorGroupSpec");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MtxGroupSpecElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.MtxGroupSpec");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class OrGroupSpecElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.OrGroupSpec");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConstraintsSpecificationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.ConstraintsSpecification");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cConstraintsKeyword_0 = (Keyword)cGroup.eContents().get(0);
	...
	public class SliceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Slice");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AggregateElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Aggregate");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//Aggregate:
		//	'aggregate' renamings?='--renamings'? (LEFT_BRACKET
		//	fms+=FMCommand+
		//	RIGHT_BRACKET | sfms=IdentifierExpr) ('withMapping' mapping=SetCommand)?;
		@Override public ParserRule getRule() { return rule; }
	...
	public class FeatureModelOperationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.FeatureModelOperation");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EditOperationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.EditOperation");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class InsertElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Insert");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class RemoveFeatureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.RemoveFeature");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class RenameFeatureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.RenameFeature");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ExtractElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Extract");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AssertionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Assertion");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VariableNullElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.VariableNull");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ExportElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Export");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class HiddenElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Hidden");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class LVidentifierElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.LVidentifier");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DependencyElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Dependency");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConfigurationCmdElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.ConfigurationCmd");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class CreateConfigurationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.CreateConfiguration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CompleteConfigurationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.CompleteConfiguration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SelectionFeatureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.SelectionFeature");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cOpAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final Alternatives cOpAlternatives_0_0 = (Alternatives)cOpAssignment_0.eContents().get(0);
	...
	public class FeatureExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.FeatureExpression");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class AutoConfigurationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.AutoConfiguration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SelectedConfigurationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.SelectedConfiguration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DeselectedConfigurationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.DeselectedConfiguration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class UnselectedConfigurationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.UnselectedConfiguration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AsFMElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.AsFM");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MapElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Map");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class UnMapElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.UnMap");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CleanUpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.CleanUp");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CoresElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Cores");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DeadsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Deads");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FullMandatorysElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.FullMandatorys");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CliquesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Cliques");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ScriptDefinitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.ScriptDefinition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ShellElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Shell");
	...
	public class ExitElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Exit");
		private final Assignment cValAssignment = (Assignment)rule.eContents().get(1);
		private final Alternatives cValAlternatives_0 = (Alternatives)cValAssignment.eContents().get(0);
	...
	public class ExistElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Exist");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cValAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class IsConflictingElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.IsConflicting");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cValAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class ListingElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Listing");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cValAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class StateElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.State");
		private final Assignment cValAssignment = (Assignment)rule.eContents().get(1);
		private final Alternatives cValAlternatives_0 = (Alternatives)cValAssignment.eContents().get(0);
	...
	public class CopyVariableElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.CopyVariable");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Alternatives cAlternatives_0 = (Alternatives)cGroup.eContents().get(0);
	...
	public class RemoveVariableElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.RemoveVariable");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Alternatives cAlternatives_0 = (Alternatives)cGroup.eContents().get(0);
	...
	public class ConvertElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Convert");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FMLSaveElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.FMLSave");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Alternatives cAlternatives_0 = (Alternatives)cGroup.eContents().get(0);
	...
	public class HierarchyElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Hierarchy");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cHierarchyKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cFmAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cFmFMCommandParserRuleCall_1_0 = (RuleCall)cFmAssignment_1.eContents().get(0);
	...
	public class PrinterUtilityElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.PrinterUtility");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cOpAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final Alternatives cOpAlternatives_0_0 = (Alternatives)cOpAssignment_0.eContents().get(0);
	...
	public class LArgsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.LArgs");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cArgsAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class GDisplayElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.GDisplay");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class GListingElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.GListing");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ModifyVOperatorElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.ModifyVOperator");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class MandatoryEditElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.MandatoryEdit");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class OptionalEditElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.OptionalEdit");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AlternativeEditElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.AlternativeEdit");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class OrEditElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.OrEdit");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AddConstraintElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.AddConstraint");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class RemoveConstraintElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.RemoveConstraint");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CNFElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.CNF");
	...
	public class Or_exprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Or_expr");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class And_exprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.And_expr");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class Impl_exprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Impl_expr");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class Biimpl_exprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Biimpl_expr");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class Unary_exprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Unary_expr");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class Neg_exprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Neg_expr");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class Primary_exprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Primary_expr");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class FeatureModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.FeatureModel");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Alternatives cAlternatives_0 = (Alternatives)cGroup.eContents().get(0);
	...
	public class ProductionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Production");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cNameAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class ChildElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Child");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		...
		//Mandatory | Optional | Xorgroup | Orgroup //                );             
		//| Mutexgroup
		public Alternatives getAlternatives() { return cAlternatives; }
	...
	public class MandatoryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Mandatory");
	...
	public class OptionalElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Optional");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cLEFT_HOOKTerminalRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
	...
	public class XorgroupElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Xorgroup");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class OrgroupElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Orgroup");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cLEFT_PARENTerminalRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final Assignment cFeaturesAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cFeaturesFT_IDParserRuleCall_1_0 = (RuleCall)cFeaturesAssignment_1.eContents().get(0);
	...
	public class MutexgroupElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.Mutexgroup");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cLEFT_PARENTerminalRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final Assignment cFeaturesAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cFeaturesFT_IDParserRuleCall_1_0 = (RuleCall)cFeaturesAssignment_1.eContents().get(0);
	...
	public class FT_IDElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.FT_ID");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class FML_IDENTIFIERElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.FML_IDENTIFIER");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
	...
	public class EditConstantElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.EditConstant");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class FeatureEdgeKindElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.FeatureEdgeKind");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class KindOfGetElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.KindOfGet");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		...
		//	CONSTRAINT_IMPLIES='getImpliesConstraint' | CONSTRAINT_EXCLUDES='getExcludesConstraint' |
	...
	public class KindOfComputeElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.KindOfCompute");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class KindOfGetGroupsElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.KindOfGetGroups");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class KindOfComputeGroupsElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.KindOfComputeGroups");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final EnumLiteralDeclaration cOREnumLiteralDeclaration_0 = (EnumLiteralDeclaration)cAlternatives.eContents().get(0);
	...
	public class BDDBackendElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.BDDBackend");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class MergeModeElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.MergeMode");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class HierarchyStrategyElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.HierarchyStrategy");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class SliceModeElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.SliceMode");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ComparisonOperatorElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.ComparisonOperator");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class SetOperatorElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.SetOperator");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class OpSelectionElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.OpSelection");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class AutoConfModeElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.AutoConfMode");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class OPT_LISTINGElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.OPT_LISTING");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class FMFormatElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.FMFormat");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class BOOL_OperatorElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.BOOL_Operator");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	private final FamiliarScriptElements pFamiliarScript;
	private final ScriptCommandElements pScriptCommand;
	private final ComplexCommandElements pComplexCommand;
	private final CommandElements pCommand;
	private final IntegerExprElements pIntegerExpr;
	private final BooleanExprElements pBooleanExpr;
	private final IdentifierExprElements pIdentifierExpr;
	private final StringExprElements pStringExpr;
	private final SetExprElements pSetExpr;
	private final AtomicConstraintExprElements pAtomicConstraintExpr;
	private final ConstraintExprElements pConstraintExpr;
	private final EditConstantElements eEditConstant;
	private final FeatureVariabilityOperatorElements pFeatureVariabilityOperator;
	private final FeatureEdgeKindElements eFeatureEdgeKind;
	private final IfConditionElements pIfCondition;
	private final ForeachSetElements pForeachSet;
	private final LTypeElements pLType;
	private final FMLAbstractCommandElements pFMLAbstractCommand;
	private final FMCommandElements pFMCommand;
	private final FTCommandElements pFTCommand;
	private final BCommandElements pBCommand;
	private final StrCommandElements pStrCommand;
	private final ConfigurationCommandElements pConfigurationCommand;
	private final SetCommandElements pSetCommand;
	private final LeavesElements pLeaves;
	private final ConstraintCommandElements pConstraintCommand;
	private final GetConstraintsElements pGetConstraints;
	private final KindOfGetElements eKindOfGet;
	private final ComputeConstraintsElements pComputeConstraints;
	private final KindOfComputeElements eKindOfCompute;
	private final GetFGroupsElements pGetFGroups;
	private final KindOfGetGroupsElements eKindOfGetGroups;
	private final ComputeFGroupsElements pComputeFGroups;
	private final KindOfComputeGroupsElements eKindOfComputeGroups;
	private final PairwiseCommandElements pPairwiseCommand;
	private final IntegerCommandElements pIntegerCommand;
	private final DoubleCommandElements pDoubleCommand;
	private final VariabilityOpCommandElements pVariabilityOpCommand;
	private final AnalysisOperationElements pAnalysisOperation;
	private final SetOperationsElements pSetOperations;
	private final SetCardElements pSetCard;
	private final SetBelongsElements pSetBelongs;
	private final SetUnionOrIntersectionElements pSetUnionOrIntersection;
	private final SetEmptyElements pSetEmpty;
	private final SetAddOrRemoveElements pSetAddOrRemove;
	private final IsEmptySetElements pIsEmptySet;
	private final SetToNamesElements pSetToNames;
	private final FeatureOperationElements pFeatureOperation;
	private final AncestorFeatureElements pAncestorFeature;
	private final DescendantFeatureElements pDescendantFeature;
	private final ChildrenFeatureElements pChildrenFeature;
	private final SiblingFeatureElements pSiblingFeature;
	private final ParentFeatureElements pParentFeature;
	private final NameFeatureElements pNameFeature;
	private final FMFeatureElements pFMFeature;
	private final FeatureOperatorElements pFeatureOperator;
	private final StringOperationElements pStringOperation;
	private final StringInitElements pStringInit;
	private final StringConcatElements pStringConcat;
	private final StringSubstringElements pStringSubstring;
	private final StringIndexOfElements pStringIndexOf;
	private final StringLengthElements pStringLength;
	private final CompareElements pCompare;
	private final ParameterElements pParameter;
	private final LoadGenericElements pLoadGeneric;
	private final CTCRCommandElements pCTCRCommand;
	private final MergeElements pMerge;
	private final BDDBackendElements eBDDBackend;
	private final MergeModeElements eMergeMode;
	private final LFMArgsElements pLFMArgs;
	private final AggregateMergeElements pAggregateMerge;
	private final HierarchyStrategyElements eHierarchyStrategy;
	private final SynthesisElements pSynthesis;
	private final KnowledgeSpecificationElements pKnowledgeSpecification;
	private final HierarchySpecificationElements pHierarchySpecification;
	private final HProductionElements pHProduction;
	private final GroupsSpecificationElements pGroupsSpecification;
	private final GroupSpecElements pGroupSpec;
	private final XorGroupSpecElements pXorGroupSpec;
	private final MtxGroupSpecElements pMtxGroupSpec;
	private final OrGroupSpecElements pOrGroupSpec;
	private final ConstraintsSpecificationElements pConstraintsSpecification;
	private final SliceElements pSlice;
	private final SliceModeElements eSliceMode;
	private final AggregateElements pAggregate;
	private final FeatureModelOperationElements pFeatureModelOperation;
	private final EditOperationElements pEditOperation;
	private final InsertElements pInsert;
	private final RemoveFeatureElements pRemoveFeature;
	private final RenameFeatureElements pRenameFeature;
	...
	private final SetOperatorElements eSetOperator;
	private final VariableNullElements pVariableNull;
	private final ExportElements pExport;
	private final HiddenElements pHidden;
	private final LVidentifierElements pLVidentifier;
	private final DependencyElements pDependency;
	private final ConfigurationCmdElements pConfigurationCmd;
	private final CreateConfigurationElements pCreateConfiguration;
	private final CompleteConfigurationElements pCompleteConfiguration;
	private final SelectionFeatureElements pSelectionFeature;
	private final FeatureExpressionElements pFeatureExpression;
	private final OpSelectionElements eOpSelection;
	private final AutoConfigurationElements pAutoConfiguration;
	private final AutoConfModeElements eAutoConfMode;
	private final SelectedConfigurationElements pSelectedConfiguration;
	private final DeselectedConfigurationElements pDeselectedConfiguration;
	private final UnselectedConfigurationElements pUnselectedConfiguration;
	private final AsFMElements pAsFM;
	private final MapElements pMap;
	private final UnMapElements pUnMap;
	private final CleanUpElements pCleanUp;
	private final CoresElements pCores;
	private final DeadsElements pDeads;
	private final FullMandatorysElements pFullMandatorys;
	private final CliquesElements pCliques;
	private final ScriptDefinitionElements pScriptDefinition;
	private final ShellElements pShell;
	private final ExitElements pExit;
	private final ExistElements pExist;
	private final IsConflictingElements pIsConflicting;
	private final ListingElements pListing;
	private final OPT_LISTINGElements eOPT_LISTING;
	private final StateElements pState;
	private final CopyVariableElements pCopyVariable;
	private final RemoveVariableElements pRemoveVariable;
	private final ConvertElements pConvert;
	private final FMFormatElements eFMFormat;
	private final FMLSaveElements pFMLSave;
	private final HierarchyElements pHierarchy;
	private final PrinterUtilityElements pPrinterUtility;
	private final LArgsElements pLArgs;
	private final GDisplayElements pGDisplay;
	private final GListingElements pGListing;
	private final ModifyVOperatorElements pModifyVOperator;
	private final MandatoryEditElements pMandatoryEdit;
	private final OptionalEditElements pOptionalEdit;
	private final AlternativeEditElements pAlternativeEdit;
	private final OrEditElements pOrEdit;
	private final AddConstraintElements pAddConstraint;
	private final RemoveConstraintElements pRemoveConstraint;
	private final CNFElements pCNF;
	private final Or_exprElements pOr_expr;
	private final And_exprElements pAnd_expr;
	private final Impl_exprElements pImpl_expr;
	private final Biimpl_exprElements pBiimpl_expr;
	private final Unary_exprElements pUnary_expr;
	private final Neg_exprElements pNeg_expr;
	private final Primary_exprElements pPrimary_expr;
	private final BOOL_OperatorElements eBOOL_Operator;
	...
	private final MutexgroupElements pMutexgroup;
	private final TerminalRule tLEFT_PAREN;
	private final TerminalRule tRIGHT_PAREN;
	private final TerminalRule tB_NOT;
	private final TerminalRule tB_AND;
	private final TerminalRule tB_OR;
	private final TerminalRule tB_IMPLY;
	private final TerminalRule tB_BIMPLY;
	...
	private final TerminalRule tLEFT_HOOK;
	private final TerminalRule tRIGHT_HOOK;
	private final TerminalRule tCOMMA;
	private final TerminalRule tMETA_ATTRIBUTE_SYMBOL;
	private final FT_IDElements pFT_ID;
	private final FML_IDENTIFIERElements pFML_IDENTIFIER;
	...
	public FmlGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pFamiliarScript = new FamiliarScriptElements();
		this.pScriptCommand = new ScriptCommandElements();
		this.pComplexCommand = new ComplexCommandElements();
		this.pCommand = new CommandElements();
		this.pIntegerExpr = new IntegerExprElements();
		this.pBooleanExpr = new BooleanExprElements();
		this.pIdentifierExpr = new IdentifierExprElements();
		this.pStringExpr = new StringExprElements();
		this.pSetExpr = new SetExprElements();
		this.pAtomicConstraintExpr = new AtomicConstraintExprElements();
		this.pConstraintExpr = new ConstraintExprElements();
		this.eEditConstant = new EditConstantElements();
		this.pFeatureVariabilityOperator = new FeatureVariabilityOperatorElements();
		this.eFeatureEdgeKind = new FeatureEdgeKindElements();
		this.pIfCondition = new IfConditionElements();
		this.pForeachSet = new ForeachSetElements();
		this.pLType = new LTypeElements();
		this.pFMLAbstractCommand = new FMLAbstractCommandElements();
		this.pFMCommand = new FMCommandElements();
		this.pFTCommand = new FTCommandElements();
		this.pBCommand = new BCommandElements();
		this.pStrCommand = new StrCommandElements();
		this.pConfigurationCommand = new ConfigurationCommandElements();
		this.pSetCommand = new SetCommandElements();
		this.pLeaves = new LeavesElements();
		this.pConstraintCommand = new ConstraintCommandElements();
		this.pGetConstraints = new GetConstraintsElements();
		this.eKindOfGet = new KindOfGetElements();
		this.pComputeConstraints = new ComputeConstraintsElements();
		this.eKindOfCompute = new KindOfComputeElements();
		this.pGetFGroups = new GetFGroupsElements();
		this.eKindOfGetGroups = new KindOfGetGroupsElements();
		this.pComputeFGroups = new ComputeFGroupsElements();
		this.eKindOfComputeGroups = new KindOfComputeGroupsElements();
		this.pPairwiseCommand = new PairwiseCommandElements();
		this.pIntegerCommand = new IntegerCommandElements();
		this.pDoubleCommand = new DoubleCommandElements();
		this.pVariabilityOpCommand = new VariabilityOpCommandElements();
		this.pAnalysisOperation = new AnalysisOperationElements();
		this.pSetOperations = new SetOperationsElements();
		this.pSetCard = new SetCardElements();
		this.pSetBelongs = new SetBelongsElements();
		this.pSetUnionOrIntersection = new SetUnionOrIntersectionElements();
		this.pSetEmpty = new SetEmptyElements();
		this.pSetAddOrRemove = new SetAddOrRemoveElements();
		this.pIsEmptySet = new IsEmptySetElements();
		this.pSetToNames = new SetToNamesElements();
		this.pFeatureOperation = new FeatureOperationElements();
		this.pAncestorFeature = new AncestorFeatureElements();
		this.pDescendantFeature = new DescendantFeatureElements();
		this.pChildrenFeature = new ChildrenFeatureElements();
		this.pSiblingFeature = new SiblingFeatureElements();
		this.pParentFeature = new ParentFeatureElements();
		this.pNameFeature = new NameFeatureElements();
		this.pFMFeature = new FMFeatureElements();
		this.pFeatureOperator = new FeatureOperatorElements();
		this.pStringOperation = new StringOperationElements();
		this.pStringInit = new StringInitElements();
		this.pStringConcat = new StringConcatElements();
		this.pStringSubstring = new StringSubstringElements();
		this.pStringIndexOf = new StringIndexOfElements();
		this.pStringLength = new StringLengthElements();
		this.pCompare = new CompareElements();
		this.pParameter = new ParameterElements();
		this.pLoadGeneric = new LoadGenericElements();
		this.pCTCRCommand = new CTCRCommandElements();
		this.pMerge = new MergeElements();
		this.eBDDBackend = new BDDBackendElements();
		this.eMergeMode = new MergeModeElements();
		this.pLFMArgs = new LFMArgsElements();
		this.pAggregateMerge = new AggregateMergeElements();
		this.eHierarchyStrategy = new HierarchyStrategyElements();
		this.pSynthesis = new SynthesisElements();
		this.pKnowledgeSpecification = new KnowledgeSpecificationElements();
		this.pHierarchySpecification = new HierarchySpecificationElements();
		this.pHProduction = new HProductionElements();
		this.pGroupsSpecification = new GroupsSpecificationElements();
		this.pGroupSpec = new GroupSpecElements();
		this.pXorGroupSpec = new XorGroupSpecElements();
		this.pMtxGroupSpec = new MtxGroupSpecElements();
		this.pOrGroupSpec = new OrGroupSpecElements();
		this.pConstraintsSpecification = new ConstraintsSpecificationElements();
		this.pSlice = new SliceElements();
		this.eSliceMode = new SliceModeElements();
		this.pAggregate = new AggregateElements();
		this.pFeatureModelOperation = new FeatureModelOperationElements();
		this.pEditOperation = new EditOperationElements();
		this.pInsert = new InsertElements();
		this.pRemoveFeature = new RemoveFeatureElements();
		this.pRenameFeature = new RenameFeatureElements();
		...
		this.eSetOperator = new SetOperatorElements();
		this.pVariableNull = new VariableNullElements();
		this.pExport = new ExportElements();
		this.pHidden = new HiddenElements();
		this.pLVidentifier = new LVidentifierElements();
		this.pDependency = new DependencyElements();
		this.pConfigurationCmd = new ConfigurationCmdElements();
		this.pCreateConfiguration = new CreateConfigurationElements();
		this.pCompleteConfiguration = new CompleteConfigurationElements();
		this.pSelectionFeature = new SelectionFeatureElements();
		this.pFeatureExpression = new FeatureExpressionElements();
		this.eOpSelection = new OpSelectionElements();
		this.pAutoConfiguration = new AutoConfigurationElements();
		this.eAutoConfMode = new AutoConfModeElements();
		this.pSelectedConfiguration = new SelectedConfigurationElements();
		this.pDeselectedConfiguration = new DeselectedConfigurationElements();
		this.pUnselectedConfiguration = new UnselectedConfigurationElements();
		this.pAsFM = new AsFMElements();
		this.pMap = new MapElements();
		this.pUnMap = new UnMapElements();
		this.pCleanUp = new CleanUpElements();
		this.pCores = new CoresElements();
		this.pDeads = new DeadsElements();
		this.pFullMandatorys = new FullMandatorysElements();
		this.pCliques = new CliquesElements();
		this.pScriptDefinition = new ScriptDefinitionElements();
		this.pShell = new ShellElements();
		this.pExit = new ExitElements();
		this.pExist = new ExistElements();
		this.pIsConflicting = new IsConflictingElements();
		this.pListing = new ListingElements();
		this.eOPT_LISTING = new OPT_LISTINGElements();
		this.pState = new StateElements();
		this.pCopyVariable = new CopyVariableElements();
		this.pRemoveVariable = new RemoveVariableElements();
		this.pConvert = new ConvertElements();
		this.eFMFormat = new FMFormatElements();
		this.pFMLSave = new FMLSaveElements();
		this.pHierarchy = new HierarchyElements();
		this.pPrinterUtility = new PrinterUtilityElements();
		this.pLArgs = new LArgsElements();
		this.pGDisplay = new GDisplayElements();
		this.pGListing = new GListingElements();
		this.pModifyVOperator = new ModifyVOperatorElements();
		this.pMandatoryEdit = new MandatoryEditElements();
		this.pOptionalEdit = new OptionalEditElements();
		this.pAlternativeEdit = new AlternativeEditElements();
		this.pOrEdit = new OrEditElements();
		this.pAddConstraint = new AddConstraintElements();
		this.pRemoveConstraint = new RemoveConstraintElements();
		this.pCNF = new CNFElements();
		this.pOr_expr = new Or_exprElements();
		this.pAnd_expr = new And_exprElements();
		this.pImpl_expr = new Impl_exprElements();
		this.pBiimpl_expr = new Biimpl_exprElements();
		this.pUnary_expr = new Unary_exprElements();
		this.pNeg_expr = new Neg_exprElements();
		this.pPrimary_expr = new Primary_exprElements();
		this.eBOOL_Operator = new BOOL_OperatorElements();
		...
		this.pMutexgroup = new MutexgroupElements();
		this.tLEFT_PAREN = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.LEFT_PAREN");
		this.tRIGHT_PAREN = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.RIGHT_PAREN");
		this.tB_NOT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.B_NOT");
		this.tB_AND = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.B_AND");
		this.tB_OR = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.B_OR");
		this.tB_IMPLY = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.B_IMPLY");
		this.tB_BIMPLY = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.B_BIMPLY");
		this.tPLUS = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.PLUS");
		this.tMINUS = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.MINUS");
		this.tSTAR = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.STAR");
		this.tDIV = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.DIV");
		this.tEXP = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.EXP");
		this.tMULT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.MULT");
		this.tLEFT_BRACKET = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.LEFT_BRACKET");
		this.tRIGHT_BRACKET = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.RIGHT_BRACKET");
		this.tLEFT_HOOK = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.LEFT_HOOK");
		this.tRIGHT_HOOK = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.RIGHT_HOOK");
		this.tCOMMA = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.COMMA");
		this.tMETA_ATTRIBUTE_SYMBOL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Fml.META_ATTRIBUTE_SYMBOL");
		this.pFT_ID = new FT_IDElements();
		this.pFML_IDENTIFIER = new FML_IDENTIFIERElements();
	}
	...
	public FeatureVariabilityOperatorElements getFeatureVariabilityOperatorAccess() {
		return pFeatureVariabilityOperator;
	}
	...
	public SetUnionOrIntersectionElements getSetUnionOrIntersectionAccess() {
		return pSetUnionOrIntersection;
	}
	...
	public KnowledgeSpecificationElements getKnowledgeSpecificationAccess() {
		return pKnowledgeSpecification;
	}
	...
	public HierarchySpecificationElements getHierarchySpecificationAccess() {
		return pHierarchySpecification;
	}
	...
	public ConstraintsSpecificationElements getConstraintsSpecificationAccess() {
		return pConstraintsSpecification;
	}
	...
	public DeselectedConfigurationElements getDeselectedConfigurationAccess() {
		return pDeselectedConfiguration;
	}
	...
	public UnselectedConfigurationElements getUnselectedConfigurationAccess() {
		return pUnselectedConfiguration;
	}
