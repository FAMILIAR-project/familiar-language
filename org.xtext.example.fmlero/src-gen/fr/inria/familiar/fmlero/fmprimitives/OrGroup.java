 ...
 * <ul>
 *   <li>{@link fr.inria.familiar.fmlero.fmprimitives.OrGroup#getGroupHasParent <em>Group Has Parent</em>}</li>
 *   <li>{@link fr.inria.familiar.fmlero.fmprimitives.OrGroup#getGroupHasChild <em>Group Has Child</em>}</li>
 *   <li>{@link fr.inria.familiar.fmlero.fmprimitives.OrGroup#getGroupHasMax <em>Group Has Max</em>}</li>
 *   <li>{@link fr.inria.familiar.fmlero.fmprimitives.OrGroup#getGroupHasMin <em>Group Has Min</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.inria.familiar.fmlero.fmprimitives.FmprimitivesPackage#getOrGroup()
 * @model
 * @generated
 */
public interface OrGroup extends FeatureModelPrimitive, FeatureGroup
{
   ...
   * @see fr.inria.familiar.fmlero.fmprimitives.FmprimitivesPackage#getOrGroup_GroupHasParent()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.inria.familiar.fmlero.fmprimitives.OrGroup#getGroupHasParent <em>Group Has Parent</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.inria.familiar.fmlero.fmprimitives.FmprimitivesPackage#getOrGroup_GroupHasChild()
   * @model
   * @generated
   */
   ...
   * @see fr.inria.familiar.fmlero.fmprimitives.FmprimitivesPackage#getOrGroup_GroupHasMax()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.inria.familiar.fmlero.fmprimitives.OrGroup#getGroupHasMax <em>Group Has Max</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.inria.familiar.fmlero.fmprimitives.FmprimitivesPackage#getOrGroup_GroupHasMin()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.inria.familiar.fmlero.fmprimitives.OrGroup#getGroupHasMin <em>Group Has Min</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
