 ...
 * <ul>
 *   <li>{@link fr.inria.familiar.fmlero.fmprimitives.impl.AlternativeGroupImpl#getGroupHasParent <em>Group Has Parent</em>}</li>
 *   <li>{@link fr.inria.familiar.fmlero.fmprimitives.impl.AlternativeGroupImpl#getGroupHasChild <em>Group Has Child</em>}</li>
 *   <li>{@link fr.inria.familiar.fmlero.fmprimitives.impl.AlternativeGroupImpl#getGroupHasMax <em>Group Has Max</em>}</li>
 *   <li>{@link fr.inria.familiar.fmlero.fmprimitives.impl.AlternativeGroupImpl#getGroupHasMin <em>Group Has Min</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AlternativeGroupImpl extends FeatureModelPrimitiveImpl implements AlternativeGroup
{
  /**
  ...
  {
    return FmprimitivesPackage.Literals.ALTERNATIVE_GROUP;
  }
    ...
    if (groupHasParent != null && groupHasParent.eIsProxy())
    {
      ...
      if (groupHasParent != oldGroupHasParent)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, FmprimitivesPackage.ALTERNATIVE_GROUP__GROUP_HAS_PARENT, oldGroupHasParent, groupHasParent));
      }
    }
  ...
  public void setGroupHasParent(GroupHasParent newGroupHasParent)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FmprimitivesPackage.ALTERNATIVE_GROUP__GROUP_HAS_PARENT, oldGroupHasParent, groupHasParent));
  }
  ...
  public EList<GroupHasChild> getGroupHasChild()
  {
    ...
    {
      groupHasChild = new EObjectResolvingEList<GroupHasChild>(GroupHasChild.class, this, FmprimitivesPackage.ALTERNATIVE_GROUP__GROUP_HAS_CHILD);
    }
  ...
  public GroupHasMax getGroupHasMax()
  {
    if (groupHasMax != null && groupHasMax.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, FmprimitivesPackage.ALTERNATIVE_GROUP__GROUP_HAS_MAX, oldGroupHasMax, groupHasMax));
      }
    }
    return groupHasMax;
  }
  ...
  public void setGroupHasMax(GroupHasMax newGroupHasMax)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FmprimitivesPackage.ALTERNATIVE_GROUP__GROUP_HAS_MAX, oldGroupHasMax, groupHasMax));
  }
  ...
  public GroupHasMin getGroupHasMin()
  {
    if (groupHasMin != null && groupHasMin.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, FmprimitivesPackage.ALTERNATIVE_GROUP__GROUP_HAS_MIN, oldGroupHasMin, groupHasMin));
      }
    }
    return groupHasMin;
  }
  ...
  public void setGroupHasMin(GroupHasMin newGroupHasMin)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FmprimitivesPackage.ALTERNATIVE_GROUP__GROUP_HAS_MIN, oldGroupHasMin, groupHasMin));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FmprimitivesPackage.ALTERNATIVE_GROUP__GROUP_HAS_PARENT:
        if (resolve) return getGroupHasParent();
        return basicGetGroupHasParent();
      case FmprimitivesPackage.ALTERNATIVE_GROUP__GROUP_HAS_CHILD:
        return getGroupHasChild();
      case FmprimitivesPackage.ALTERNATIVE_GROUP__GROUP_HAS_MAX:
        if (resolve) return getGroupHasMax();
        return basicGetGroupHasMax();
      case FmprimitivesPackage.ALTERNATIVE_GROUP__GROUP_HAS_MIN:
