...
public class FmleroStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new fr.inria.familiar.fmlero.FmleroRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://lero.ie/spl/fmprimitives.ecore")) {
		EPackage.Registry.INSTANCE.put("http://lero.ie/spl/fmprimitives.ecore", fr.inria.familiar.fmlero.fmprimitives.FmprimitivesPackage.eINSTANCE);
	}
