 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.fmprimitives.impl.FeatureImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.fmprimitives.impl.FeatureImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.fmprimitives.impl.FeatureImpl#getGroupHasParent <em>Group Has Parent</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.fmprimitives.impl.FeatureImpl#getGroupHasChild <em>Group Has Child</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.fmprimitives.impl.FeatureImpl#getFeatureHasParent <em>Feature Has Parent</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.fmprimitives.impl.FeatureImpl#getFeatureHasSubfeature <em>Feature Has Subfeature</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.fmprimitives.impl.FeatureImpl#getSelectedFeature <em>Selected Feature</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.fmprimitives.impl.FeatureImpl#getEliminatedFeature <em>Eliminated Feature</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.fmprimitives.impl.FeatureImpl#getUndirectedRelationships <em>Undirected Relationships</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.fmprimitives.impl.FeatureImpl#getIncomingDirectedRelationships <em>Incoming Directed Relationships</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.fmprimitives.impl.FeatureImpl#getOutgoingDirectedRelationships <em>Outgoing Directed Relationships</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.fmprimitives.impl.FeatureImpl#getFeatureIsRoot <em>Feature Is Root</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
