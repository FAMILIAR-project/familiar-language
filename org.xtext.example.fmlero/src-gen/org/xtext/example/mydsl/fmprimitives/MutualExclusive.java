 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.fmprimitives.MutualExclusive#getRelatedFeatures <em>Related Features</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.example.mydsl.fmprimitives.FmprimitivesPackage#getMutualExclusive()
 * @model
 * @generated
 */
public interface MutualExclusive extends FeatureModelPrimitive, UndirectedRelationship
{
   ...
   * @see org.xtext.example.mydsl.fmprimitives.FmprimitivesPackage#getMutualExclusive_RelatedFeatures()
   * @model
   * @generated
   */
