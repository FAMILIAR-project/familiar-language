 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.fmprimitives.AlternativeGroup#getGroupHasParent <em>Group Has Parent</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.fmprimitives.AlternativeGroup#getGroupHasChild <em>Group Has Child</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.fmprimitives.AlternativeGroup#getGroupHasMax <em>Group Has Max</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.fmprimitives.AlternativeGroup#getGroupHasMin <em>Group Has Min</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.example.mydsl.fmprimitives.FmprimitivesPackage#getAlternativeGroup()
 * @model
 * @generated
 */
public interface AlternativeGroup extends FeatureModelPrimitive, FeatureGroup
{
   ...
   * @see org.xtext.example.mydsl.fmprimitives.FmprimitivesPackage#getAlternativeGroup_GroupHasParent()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.fmprimitives.AlternativeGroup#getGroupHasParent <em>Group Has Parent</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.fmprimitives.FmprimitivesPackage#getAlternativeGroup_GroupHasChild()
   * @model
   * @generated
   */
   ...
   * @see org.xtext.example.mydsl.fmprimitives.FmprimitivesPackage#getAlternativeGroup_GroupHasMax()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.fmprimitives.AlternativeGroup#getGroupHasMax <em>Group Has Max</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.fmprimitives.FmprimitivesPackage#getAlternativeGroup_GroupHasMin()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.fmprimitives.AlternativeGroup#getGroupHasMin <em>Group Has Min</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
